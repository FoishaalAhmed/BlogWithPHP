        ...
        <div class="block">  
			...
			<tbody>
				<?php 
					...
					inner join tbl_catagory on tbl_post.cat = tbl_catagory.id order 
					by tbl_post.title desc ";
				...
				<tr class="odd gradeX">
					...
					<td><?php echo $format->textShort($result ['body'], 50); ?></td>
					...
					<td>
						...
						<?php if (Session::get("userId") == $result['userid'] || Session::get("userRole") == '0') { ?>
								...
								<a onclick = "return confirm('are you sure to delete??');" href="deletpost.php?deletpostid=<?php echo $result['id']; ?>">Delete</a>
						<?php	} ?> 
